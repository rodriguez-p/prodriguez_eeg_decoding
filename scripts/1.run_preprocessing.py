...
Defines and runs functions for the pre-processing of the raw EEG data across subjects. Saves epoched clean data.
"""
...
def preprocessing(id, block_type):
    raw = mne.io.read_raw_brainvision("{}/S{}/{}{:06d}.vhdr".format(RAW_DATA, id, FILE_PREFIX), preload=True, eog={'EOG1', 'EOG2'})
...
# run the preprocessing steps across subjects
block_type = [70, 71]
